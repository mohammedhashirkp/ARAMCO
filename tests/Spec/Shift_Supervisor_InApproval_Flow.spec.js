...
test("Shift Supervisor In Approval Flow Working or not ? ", async ({ page }) => {
  const loginPage = new LoginPage(page);
  const ShiftSupervisorInApprovalFlow = new Shift_Supervisor_InApproval_Flow(page);
  ...
  //check the status s correct or not
  await ShiftSupervisorInApprovalFlow.validateChecklistStatus("In Approval");
